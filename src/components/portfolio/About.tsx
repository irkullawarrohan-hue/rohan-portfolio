...
export function About() {
  return (
    ...
    >
      <div className="mb-6 flex items-center gap-3 text-[10px] md:text-[11px] uppercase tracking-[0.24em] text-muted-foreground">
        ...
        {pillars.map((p, i) => (
          <Reveal key={p.title} delay={i * 0.05}>
            <div className="group relative h-full overflow-hidden rounded-2xl border border-border bg-card p-6 transition-all duration-300 hover:-translate-y-0.5 hover:border-foreground/30">
              ...
              <h3 className="mt-6 text-base md:text-lg font-medium tracking-tight">
                {p.title}
              </h3>
