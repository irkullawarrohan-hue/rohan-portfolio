...
export function Resume() {
  return (
    <section id="resume" className="scroll-mt-24 border-t border-border py-24 md:py-32">
        ...
        <Reveal>
          <div className="rounded-3xl border border-border bg-card p-10 text-center md:p-20">
            ...
            <p className="mx-auto mt-5 max-w-xl text-muted-foreground">
              A concise, recruiter-friendly PDF with skills, projects, and contact — refreshed with
