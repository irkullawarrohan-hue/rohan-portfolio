...
export const PROJECTS: Project[] = [
  ...
  },
  {
  ...
  },
   {
    ...
    description: "Provisioned a production-ready AWS infrastructure using Terraform and automated container deployments to Amazon ECS Fargate with GitHub Actions CI/CD.",
    tech: [
    "Terraform",
    "Amazon ECS Fargate",
    "Amazon ECR",
    ...
    problem: "Manual infrastructure and deployments were slow, error-prone, and inconsistent.",
    challenges: "Built modular Terraform, secure networking, and automated CI/CD with OIDC.",
    learnings: "Terraform, ECS Fargate, CI/CD, OIDC, AWS networking, and Infrastructure as Code.",
